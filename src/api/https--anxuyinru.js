...
// axios.defaults.baseURL = 'http://192.168.22.52:8080'; // gjh
// axios.defaults.baseURL = 'http://192.168.22.79:8080'; // lfj
// axios.defaults.baseURL = 'http://39.105.41.146:8080';
// axios.defaults.baseURL = 'http://192.168.28.121/mock/97'; // yapi地址
axios.defaults.baseURL = 'http://192.168.29.53:8082/api'; // 测试服务器地址
// axios.defaults.baseURL = 'http://39.105.41.140:80/api'; // 正式服务器地址
// http request 拦截器y
...
export const ApiService = {
  // 登录
  portalLogin: (params) => {
    return axios.post('v2/user/login', params).then(res => res.data);
  },
  // 个人信息/权限
  getProfile: () => {
